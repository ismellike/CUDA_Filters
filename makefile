...
INCLUDES  := -I../../common/inc -I../Packed3DArray -I../ImageReader -I../ImageWriter
...
$(PROG): $(PROG).o $(LIB)
	$(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIB)
...
clean:
	...
	rm -f ../ImageReader/*.o 
	rm -f ../ImageReader/*.so
	rm -f ../lib/libCOGLImageReader.so
	rm -f ../lib/libCOGLImageWriter.so
	rm -f *.o $(PROG)